...
define('text!views/../../templates/icon.html',[],function () { return '<div class="b-icon b-icon_<%= side %>" style="background-image:url(<%= image %>)">\n\t\n</div>\n<div class="b-link b-link_<%= side %>" data-id="<%= id %>">\n\t<img src="<%= image %>" />\n\t<span><%= name %></span>\n</div>';});

(function() {
  define('views/vote',['jquery', 'underscore', 'backbone', 'imagesLoaded', 'text!../../templates/icon.html'], function($, _, Backbone, imagesLoaded, iconTemplate) {
    var VoteView;
...
(function() {
  define('views/share',['jquery', 'underscore', 'backbone', 'imagesLoaded', 'text!../../templates/share.html'], function($, _, Backbone, imagesLoaded, shareTemplate) {
    var VoteView;
    VoteView = Backbone.View.extend({
